...
// Slug-safe variant: slug fields only accept lowercase letters — uppercase, integers,
// and special characters are rejected by the input and would break value assertions.
export const randomLowerAlpha = (length) => {
...
export const randomHexColor = (length = 6) => {
...
// Needed when a user-provided value (e.g. a security payload title) is used to
// build a RegExp, such as the grid row lookup in SiteInstancesPage.
